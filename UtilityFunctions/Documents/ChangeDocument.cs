...
namespace Utilities.Documents
{
    public partial class ChangeDocument : HAWK_Template_2  
    {
       ...
       //     LoadBBasicDocInfo();
        ...
        protected virtual void button_GetDocument(string cmdStr)
        {
            try
            {
             ...
             //   textBox_TableName.Text = 
                ...
                textBox_ExpectedAmount.Text = fields[8].ToString();     //  quotedAmount 
        ...
        {
          //  new Applications.Applications.Accounting.Transactions.CreateTransaction(ident, textBox_TableName.Text, textBox_DocNum.Text, textBox_DocType.Text).Show();
        }
